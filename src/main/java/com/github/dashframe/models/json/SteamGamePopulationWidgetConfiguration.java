...
public class SteamGamePopulationWidgetConfiguration
    extends WidgetConfiguration<SteamGamePopulationWidgetConfiguration> {
     ...
     * @return parameters
     */
    /*public @NotNull @Valid SteamGameNewsWidgetConfigurationAllOfParameters getParameters() {
        return parameters;
    }*/
