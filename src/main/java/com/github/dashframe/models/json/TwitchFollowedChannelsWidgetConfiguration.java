...
public class TwitchFollowedChannelsWidgetConfiguration implements WidgetConfiguration {
    ...
    public TwitchFollowedChannelsWidgetConfiguration type(String type) {
        this.type = type;
        return this;
    }
    ...
    public TwitchFollowedChannelsWidgetConfiguration name(String name) {
        this.name = name;
        return this;
    }
    ...
    public TwitchFollowedChannelsWidgetConfiguration refreshRate(Integer refreshRate) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.type, twitchFollowedChannelsWidgetConfiguration.type) &&
            Objects.equals(this.name, twitchFollowedChannelsWidgetConfiguration.name) &&
            Objects.equals(this.refreshRate, twitchFollowedChannelsWidgetConfiguration.refreshRate) &&
