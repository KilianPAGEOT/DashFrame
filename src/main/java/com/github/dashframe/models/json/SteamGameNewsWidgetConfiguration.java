...
public class SteamGameNewsWidgetConfiguration implements WidgetConfiguration {
    ...
    public SteamGameNewsWidgetConfiguration type(String type) {
        this.type = type;
        return this;
    }
    ...
    public SteamGameNewsWidgetConfiguration name(String name) {
        this.name = name;
        return this;
    }
    ...
    public SteamGameNewsWidgetConfiguration refreshRate(Integer refreshRate) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.type, steamGameNewsWidgetConfiguration.type) &&
            Objects.equals(this.name, steamGameNewsWidgetConfiguration.name) &&
            Objects.equals(this.refreshRate, steamGameNewsWidgetConfiguration.refreshRate) &&
