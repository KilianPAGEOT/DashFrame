...
public class WeatherTimeWidgetConfiguration implements WidgetConfiguration {
    ...
    public WeatherTimeWidgetConfiguration type(String type) {
        this.type = type;
        return this;
    }
    ...
    public WeatherTimeWidgetConfiguration name(String name) {
        this.name = name;
        return this;
    }
    ...
    public WeatherTimeWidgetConfiguration refreshRate(Integer refreshRate) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.type, weatherTimeWidgetConfiguration.type) &&
            Objects.equals(this.name, weatherTimeWidgetConfiguration.name) &&
            Objects.equals(this.refreshRate, weatherTimeWidgetConfiguration.refreshRate) &&
